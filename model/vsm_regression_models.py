...
REGRESSION_MODELS_PAPER = {
    "elastic_net": ElasticNet(max_iter=50),
    ...
    "gradient_boosting": GradientBoostingRegressor(n_estimators=50, max_depth=10, max_leaf_nodes=100),
    "mlp": MLPRegressor(hidden_layer_sizes=(256, 256, 256, 256, 256, 256, 256,),
                        max_iter=50,
                        early_stopping=True,
                        shuffle=True,
                        activation="relu",
                        batch_size=16, verbose=True),
    "random_forest": RandomForestRegressor(n_estimators=50, n_jobs=8, max_depth=10, max_leaf_nodes=100),
    "svr_poly_rbf": SVR(C=1.0, epsilon=0.2, kernel="rbf", max_iter=50),
    "xgboost": xgb.XGBRegressor(n_estimators=50, max_depth=10, n_jobs=8),
    "ensemble_voting_bg_mlp_gd_xgb":
        VotingRegressor(n_jobs=8, estimators=[
            ("mlp", MLPRegressor(hidden_layer_sizes=(256, 256, 256, 256, 256, 256, 256,),
                                 max_iter=50,
                                 early_stopping=True,
                                 shuffle=True,
...
REGRESSION_BIG_MODELS_PAPER = {
    ...
    "xgboost": xgb.XGBRegressor(n_estimators=100, n_jobs=8),
    "mlp": MLPRegressor(hidden_layer_sizes=(512, 512, 512, 512, 512, 512, 512,),
                        max_iter=100,
                        shuffle=True,
                        activation="relu",
                        batch_size=16),
    "random_forest": RandomForestRegressor(n_estimators=100, n_jobs=8),
    "svr_poly_rbf": SVR(C=1.0, epsilon=0.2, kernel="rbf", max_iter=100),
    "ensemble_voting_bg_mlp_gd_xgb":
        VotingRegressor(n_jobs=8, estimators=[
            ('bagging', BaggingRegressor(n_estimators=100, n_jobs=8)),
            ('mlp', MLPRegressor(hidden_layer_sizes=(512, 512, 512, 512, 512, 512, 512,),
                                 ...
                                 activation="relu",
                                 batch_size=16)),
            ('xgb', xgb.XGBRegressor(n_estimators=100, n_jobs=8)),
            ('gd', GradientBoostingRegressor(n_estimators=100))
        ])
}
